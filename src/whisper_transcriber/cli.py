...
def main(url, output, model, language, format, device, keep_audio, verbose):
    """
    ...
    try:
        ...
        if verbose:
            ...
            # Show model type
            model_type = "Hebrew-optimized" if model in WhisperTranscriber.HEBREW_MODELS else "Standard OpenAI"
